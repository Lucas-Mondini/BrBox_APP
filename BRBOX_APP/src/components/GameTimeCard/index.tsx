    ...
    >
      <View style={[styles.card,]}>
        <View style={[styles.gameTimeInfo]}>
          <Text style={[styles.rate]}><Text style={[styles.rateBig]}>{typeof rate === "number" ? rate : 0}</Text>/10</Text>
          <View style={[styles.gameTimeContainer]}>
            <Text style={[styles.text, {color, textDecorationLine: !gameTime ? "underline" : "none"}]}>{getTerm(!gameTime ? 100138 : 100140).replace("%1", String(formatGameTime()))}</Text>
